...
export async function GET(req) {
  ...
  try {
    ...
    if (!spreadsheetId)
      return NextResponse.json({ msg: 'GOOGLE_SHEET_ID no configurado en .env.local' }, { status: 400 })
    ...
    console.error('[google-sheets/test]', e)
    return NextResponse.json({ msg: 'Error al conectar: ' + e.message }, { status: 500 })
  }
}