      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            {detail?.pdf_url ? (
              <Btn onClick={onOpenPDF} style={{ background: 'rgba(255,255,255,.2)', borderColor: 'rgba(255,255,255,.4)', color: '#fff' }}>
                📄 Ver PDF
              </Btn>
            ) : (
              <Btn
          ...
          {!loading && detail && (
            <>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <Btn variant="outline" small onClick={onEditHeader}>
                  ✏️ Editar
                </Btn>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                ...
                <Btn variant="outline" small onClick={onEditMetrics}>
                  ✏️ Editar
                </Btn>
              </div>
...
function InspeccionesTab() {
  ...
  const S = {
    ...
    th: { padding: '10px 14px', textAlign: 'left', color: '#15803d', fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.6, borderBottom: '2px solid #e5e7eb', background: '#f8fafc' },
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: 12, marginBottom: 12 }}>
        <div>
          ...
          <p style={{ margin: '3px 0 0', color: '#6b7280', fontSize: 13 }}>
            {filtered.length} de {inspecciones.length}
          </p>
        </div>
      ...
      <div style={S.card}>
        <table style={S.tbl}>
          ...
          <tbody>
            ...
            {filtered.length === 0 && (
              <tr>
                <td colSpan={6} style={{ ...S.td, textAlign: 'center', color: '#9ca3af', padding: 36 }}>
                  Sin resultados
                </td>
              </tr>
            )}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 12 }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e => setHeaderDraft(p => ({ ...p, packaging_date: e.target.value }))}
                  />
                </div>
              </div>
            </div>
              ...
              <tr key={u.id}>
                ...
                <td style={S.td}>
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    <Btn variant={u.active ? 'gray' : 'primary'} small onClick={() => toggleActive(u)}>
        ...
        <div style={S.modalOv} onClick={e => e.target === e.currentTarget && setCreateOpen(false)}>
          <div style={S.modal}>
            <div style={S.modalHead}>
              ...
              <Btn variant="gray" small onClick={() => setCreateOpen(false)}>✕</Btn>
            </div>
        ...
        <div style={S.modalOv} onClick={e => e.target === e.currentTarget && setEditOpen(false)}>
          <div style={S.modal}>
            <div style={S.modalHead}>
              ...
              <Btn variant="gray" small onClick={() => setEditOpen(false)}>✕</Btn>
            </div>
